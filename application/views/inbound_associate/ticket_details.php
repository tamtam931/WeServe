	  	...
	  	<div class="col-md-3">
			  ...
			  <div class="card-body">
		  		<div class="row">
			            ...
			            <input type="text" class="form-control" id="project" name="project" placeholder="" value="<?= $ticket_details->project ?>">
			            ...
			            <input type="text" class="form-control" id="unit" name="unit" placeholder="" value="<?= $ticket_details->unit ?>">
			            ...
			            <input type="text" class="form-control" id="ticket_type" name="ticket_type" placeholder="" value="Turnover of Unit/Parking">

			            <label for="assigned_to">Assigned To</label>
			            <input type="text" class="form-control" id="assigned_to" name="assigned_to" placeholder="" value="Outbound Associate">
