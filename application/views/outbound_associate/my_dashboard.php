	  		...
	  		<div class="col-md-2">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">Open 
				    	<span class="badge badge-warning badge-pill">
		    				<?php $data = $this->Admin_model->get_ticket_status_by_role_user_id('OUTBOUND_ASSOC', user('id'), 0); 
		    					if($data) {
		    						echo count($data);
		    					} else { echo 0; }
		    				?>
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">Overdue 
				    	<span class="badge badge-warning badge-pill">
		    				<?php $data = $this->Admin_model->get_ticket_overdue_by_role_user_id_status('OUTBOUND_ASSOC', user('id')); 
		    					if($data) {
		    						echo count($data);
		    					} else { echo 0; }
		    				?>
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">Due Today 
				    	<span class="badge badge-warning badge-pill">
		    				<?php $data = $this->Admin_model->get_ticket_due_today_by_role_user_id_status('OUTBOUND_ASSOC', user('id')); 
		    					if($data) {
		    						echo count($data);
		    					} else { echo 0; }
		    				?>
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">Complete Activity
				    	<span class="badge badge-warning badge-pill">
		    				<?php $data = $this->Admin_model->get_ticket_complete_activity_by_role_user_id_status('OUTBOUND_ASSOC', user('id')); 
		    					if($data) {
		    						echo count($data);
		    					} else { echo 0; }
		    				?>
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">Closed
				    	<span class="badge badge-warning badge-pill">
		    				<?php $data = $this->Admin_model->get_ticket_status_by_role_user_id('OUTBOUND_ASSOC', user('id'), 1); 
		    					if($data) {
		    						echo count($data);
		    					} else { echo 0; }
		    				?>
		  	...
		  	<div class= "col-md-12">
		  		...
		  		<table class="table" id="tickets_table">
				  	...
				  	<tbody>
					    ...
					    <tr>
					      <th scope="row"><a href="<?= base_url('outbound/ticket_details/'.$ticket->ticket_id); ?>"> <?= $ticket->ticket_number; ?></a></th>
