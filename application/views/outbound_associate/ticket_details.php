		            ...
		            <div class="modal-content">
		               ...
		               <div class="modal-footer">
					        <!-- <button type="submit" class="btn btn-dark" data-toggle="modal" data-target="#call_success_confirm">Answer</button> -->
					          <a href="<?= base_url('sapCustomerController/call?extension='.$ticket_details->extension_number.'&number=1000&ticket_id='.$ticket_details->ticket_id); ?>" class="btn btn-dark">Call</a>
