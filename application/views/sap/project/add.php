<?= form_open('sap/project'); ?>
	...
	<div class="from-group">
		<?= form_label('SAP Project Resource', 'sap_resource') ?>
		<?= form_input("sap_resource",'Projects',['id' => 'sap_resource','class' => 'form-control','placeholder' => 'API Resource','readonly' => 'readonly']); ?>		
	</div>
	<hr>
	<p class="lead">Do you really want to Fetch data from SAP</p>
	<?= form_submit('submit','Fetch Now',['class' => 'add_project btn btn-primary btn-block btn-sm']); ?>
<?= form_close() ?>