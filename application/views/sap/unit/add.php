<?= form_open('sap/unit'); ?>
	<h4 class="text-info">Fetching Units Data Reminder</h4>
	...
	<div class="from-group">
		...
		<?= form_input("sap_resource",'Units',['id' => 'sap_resource','class' => 'form-control','placeholder' => 'API Resource','readonly' => 'readonly']); ?>		
	</div>
	<hr>
	<p class="lead">Do you really want to Fetch data from SAP</p>
	<?= form_submit('submit','Fetch Now',['class' => 'add_unit btn btn-primary btn-block btn-sm']); ?>
<?= form_close() ?>