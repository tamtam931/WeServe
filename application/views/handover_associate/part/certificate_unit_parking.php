...
<div id="certificate_div" class="row" style=" text-align: center; ">
		...
		<div class="col-md-12">
			<ul style="padding-top: 10px; list-style-type: none;">
				...
				<li style="padding-top: 10px;"><b>TOTAL AREA : </b> 
					<?php $sum = 0; $parking_area = 0; $floor_area = 0;
					$parking_area = $ticket_details->parking_floor_area; 
					$floor_area = $ticket_details->floor_area;
					$sum = intval($parking_area) + intval($floor_area);
					echo $sum;
					 ?>
				</li>
			</ul>
