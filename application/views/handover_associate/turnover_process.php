					  ...
					  <div class="modal-dialog modal-dialog-centered" role="document">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        <button type="button" data-toggle="modal" data-target="#summary_punchlist" class="btn btn-primary">Yes</button>
			      	...
			      	<form id="form_other_concern"  role="form" method="POST" enctype="multipart/form-data">
			      		<div class="modal-body">
					        ...
					        <div class="col-md-12 mb-3">
					            ...
					            <select class="custom-select d-block w-100" id="temp_parking" name="temp_parking">
					            <option value=""></option>
						    ...
						    <div class="col-md-12 mb-3">
					            ...
					            <textarea rows="3" class="form-control" name="temp_parking_remarks"></textarea> 
						    </div>
